...
| Convert a PyTorch model to `.aimodel` — which path, the five lines, the gotchas | [`knowledge/conversion-guide.md`](knowledge/conversion-guide.md) — decision table first, then the canonical API |
