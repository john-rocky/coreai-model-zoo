...
| [**APUS-OpenJev-v1-4B**](models/apus-openjev-v1-4b/README.md) (Qwen3.5-4B decision model, apus-ailab — browser actions / workflow routing / proposition judgments through A–P letter probabilities; LM head retained; int8hu 5.77 GB, fp32-oracle option argmax 48/48, max \|Δp\| 0.005302; M4 Max S=1 prefill proxy 81.8 tok/s pipelined / 69.4 sequential) | [🤗 APUS-OpenJev-v1-4B-CoreAI](https://huggingface.co/mlboydaisuke/APUS-OpenJev-v1-4B-CoreAI) | Measured through coreai-kit sequential: tokens / slots / option argmax 40/40 choice+noul; SemIf authored144 mean family balanced accuracy 0.906 | Apache-2.0 |
...
| **CC BY-NC 4.0** · [**OpenJev**](models/openjev-27b/README.md) (source openjev/openjev; text-only 27B Choice / Noul / Score; int8hu 27.8 GiB, author BF16 reference; Mac GPU argmax 61/61, max \|Δp\| 0.000276405407, engines 122/122; the AOT python readout gate peaked at 111.9 GB RSS; the kit's sequential engine holds it at about 28 GB resident) | [🤗 OpenJev-CoreAI](https://huggingface.co/mlboydaisuke/OpenJev-CoreAI) | Measured through coreai-kit: tokens/slots/argmax 61/61, max \|Δp\| 0.0003; SemIf authored144 mean family balanced accuracy 0.907; median 9.3 s per fixture question, contended | CC BY-NC 4.0 |
