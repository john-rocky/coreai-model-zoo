...
`ios/` until Hub revision `672f4a0c`, 2026-09-26), `labels.json` alongside. On the iPhone 18 Pro (h19p) the JIT bundle loaded in 2.22 s on a fresh install, ran a first call in 1.19 s and loaded in
0.56 s on relaunch (load-only check, 2026-09-26). Catalog id: **`vjepa2-vitl-ssv2`**.
