...
swift run -c release chat-cli --model nemotron-3-nano-4b --prompt "What can you do, offline?"
```
...
- First run downloads the model — ~4,626 MB (Mac) / ~4,629 MB (iPhone) — then it loads from the
