...
| [`minicpm5-1b.md`](minicpm5-1b/README.md) | MiniCPM5-1B (plain Llama dense, OpenBMB) | [🤗 MiniCPM5-1B-CoreAI](https://huggingface.co/mlboydaisuke/MiniCPM5-1B-CoreAI) | 1.08B int8 per-block-32 (rebuilt 2026-09-09; the per-channel bundle had dead LM-head rows and never halted), 24/24 + stop-exact vs HF fp32 on device, **61.7 tok/s iPhone 17 Pro**, 246.6 tok/s M4 Max (pipelined, llama→mistral remap) |
