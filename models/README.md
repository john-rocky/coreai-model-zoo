...
| [`apus-decision-v1-4b`](apus-decision-v1-4b/README.md) | APUS-Decision-v1-4B (source apus-ailab/APUS-OpenJev-v1-4B; Qwen3.5-4B text tower; 32-layer decision readout from A–P logits under the chat template; LM head retained) | [🤗 APUS-Decision-v1-4B-CoreAI](https://huggingface.co/mlboydaisuke/APUS-Decision-v1-4B-CoreAI) | int8hu 5.77 GB, Mac GPU option argmax 48/48, max \|Δp\| 0.005302, both engines 96/96; measured through coreai-kit: 40/40 choice+noul parity, SemIf authored144 mean family balanced accuracy 0.906 |
