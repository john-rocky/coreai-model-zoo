...
▶️ **Run it (source)** — the [DiffuseChat runner](https://github.com/john-rocky/coreai-kit/tree/0.7.3/Examples/DiffuseChat)
...
The take-home is [`Examples/DiffuseChat/Sources/QuickStart.swift`](https://github.com/john-rocky/coreai-kit/blob/0.7.3/Examples/DiffuseChat/Sources/QuickStart.swift)
...
- First run downloads the model — ~5,264 MB (Mac) — then it loads from the
