...
▶️ **Run it (source)** — the [UpscaleDemo runner](https://github.com/john-rocky/coreai-kit/tree/0.7.3/Examples/UpscaleDemo)
...
The take-home is [`Examples/UpscaleDemo/Sources/QuickStart.swift`](https://github.com/john-rocky/coreai-kit/blob/0.7.3/Examples/UpscaleDemo/Sources/QuickStart.swift)
...
- First run downloads the model — ~1,825 MB (Mac) / ~1,825 MB (iPhone) — then it loads from the
