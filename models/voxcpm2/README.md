...
swift run -c release speak-cli --model voxcpm2-2b --text "Hello from Core AI." --output hello.wav
```
...
- First run downloads the model — ~4,721 MB (Mac) / ~4,727 MB (iPhone) — then it loads from the
